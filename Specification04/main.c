...
int main(void) {
	...
	PSTUDENT student = CreateStudent(studentNumber, name);
	...
	PSTUDENT student2 = CreateStudent(studentNumber2, name2);
	...
	PSTUDENT student3 = CreateStudent(studentNumber3, name3);
	...
	PSTUDENT student4 = CreateStudent(studentNumber4, name4);

	PSTUDENT studentArray[sizeof(STUDENT)][STUDENT_ARRAY_SIZE];
